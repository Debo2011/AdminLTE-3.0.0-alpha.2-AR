...
include('connect.php');
$id = $_GET["id"];
$sql = "select * from assettypes where  AssetTypeID = $id";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") 
{
  ...
  $sql = "update assettypes set AssetTypeName = '$AssetTypeName' where AssetTypeID = $AssetTypeID ";
          ...
          <div class="row">
             ...
             <form action="#" method="POST" enctype="multipart/form-data">
                <div class="card">
                    <div class="card-body">
                       <div class="card">
                          <div class="card-header bg-info" > تعديل نوع الاصل  </div>
                             <div class="card-body">
                                 <div class="row">
                                 ...
                                 <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="AssetTypeName" id="AssetTypeName" value="<?php echo $AssetTypeName?>"  class="form-control">
                                        <p class="red"></p>
                                    </div>
                                    <input type="hidden" name="AssetTypeID" id="AssetTypeID" value="<?php echo $AssetTypeID?>" class="form-control">
                                 </div>
