             ...
             <form action="#" method="POST" enctype="multipart/form-data">
                <div class="card">
                  ...
                  <div class="col-md-6">
                    ...
                    ?>
                     <input type="hidden" name="OrderID" id="OrderID" value="<?php echo $OrderID?>" class="form-control">
                                 <label for=""> الحالة </label>
                                      <select name="OrderStatusID" require="require" id="OrderStatusID" class="form-control">
                                        <option value="">إختر الحالة</option>
                                        <?php
                                        if ($resultorderstatues->num_rows > 0) {
                                          while($row = $resultorderstatues->fetch_assoc()) {
                                        echo "<option value=".$row["OrderStatusID"].">".$row["OrderStatusName"] ."</option>";
