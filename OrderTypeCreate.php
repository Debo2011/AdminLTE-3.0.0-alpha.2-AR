                             ...
                             <div class="card-body">
                                 ...
                                 <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="OrderTypeName" id="OrderTypeName" class="form-control">
                                        <p class="red"></p>
                                    </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") 
{
  ...
  $OrderTypeName = test_input($_POST["OrderTypeName"]);
  $sql = "INSERT INTO `ordertypes`(`OrderTypeName`) VALUES ('$OrderTypeName')";
