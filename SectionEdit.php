...
if ($_SERVER["REQUEST_METHOD"] == "POST") 
{
  ...
  $sql = "update sections set SectionName = '$SectionName' where SectionID = $SectionID ";
                             ...
                             <div class="card-body">
                                 ...
                                 <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="SectionName" id="SectionName" value="<?php echo $SectionName?>" class="form-control">
                                        <p class="red"></p>
                                    </div>
                                    <input type="hidden" name="SectionID" id="SectionID" value="<?php echo $SectionID?>" class="form-control">
                                 </div>
